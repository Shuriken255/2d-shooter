...
public class GreenLight /* But not in Steam :) */ extends GameObject{
	float positionX, positionY;
	
	public GreenLight(String layer, float posX, float posY, float size){
		super(layer);
		this.sizeX = size*2;
		this.sizeY = size*2;
		this.posX = posX-size/2;
		this.posY = posY-size/2;
		this.setTexture("interface_green_light");
		positionX = this.posX;
		positionY = this.posY;
		this.posX += Menu.POSX;
		this.posY += Menu.posY;
